    ...
    return (
      <Card style={styles.card}>
        ...
        <View style={styles.descriptionBlock}>
          <Text style={styles.descriptionTitle}>Poste : {item.offre.poste}</Text>
          <Text style={styles.descriptionTitle}>Description : {item.offre.description}</Text>
          <Text style={styles.descriptionTitle}>Compétences : {item.offre.competences}</Text>
        </View>

        {isExpanded && (
          <View style={styles.descriptionBlock}>
            <Text style={styles.descriptionTitle}>Date de début : {item.offre.date_debut}</Text>
            <Text style={styles.descriptionTitle}>Date limite : {item.offre.date_limite}</Text>
            <Text style={styles.descriptionTitle}>Contact : {item.offre.contact}</Text>
            <Text style={styles.descriptionTitle}>Tags : {item.offre.tags}</Text>
            <Text style={styles.descriptionTitle}>Type d'offre : {item.offre.type_offre}</Text>
          </View>
        )}

        <TouchableOpacity onPress={() => toggleExpand(item.offre.id)}>
          <Text style={styles.toggleText}>{isExpanded ? 'Voir moins ▲' : 'Voir plus ▼'}</Text>
        </TouchableOpacity>
